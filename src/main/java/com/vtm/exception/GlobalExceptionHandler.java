...
import static com.vtm.exception.EErrorType.BAD_REQUEST_ERROR;
import static com.vtm.exception.EErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(VTMProjectException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(VTMProjectException exception){
